  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        // 2c. Hotfix fidélité musicale — deferred playback anchor math (pure).
        "apps/web/src/features/listener/lib/playback.ts",
      ...
      // would make CI fragile on out-of-scope UI / plumbing files); only the 10
